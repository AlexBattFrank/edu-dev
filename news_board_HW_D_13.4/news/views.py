...
# но при этом в settings.py.LOGGING нужно описать иерархию loggers
# и использовать propagate для исключения двойной обработки сообщений
# разными loggers находящимися в одной иерархии
...
def index_test(request):
    ...
    logger.critical("Test --------CRITICAL--------Test")
    return HttpResponse("<p> This is the message for test page </p>")
